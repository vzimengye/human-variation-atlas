export const visualAssets = {
  hands:
    'https://live.staticflickr.com/7364/27623264486_9de40bdef3_o.jpg',
  microscope:
    'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Scientist_at_the_Microscope.jpg/960px-Scientist_at_the_Microscope.jpg',
  skinMap:
...
export const homeFeatureNotes = [
  { label: 'Browse', title: 'Traits', tone: 'deep' },
  { label: 'Read', title: 'Interpretations', tone: 'soft' },
  { label: 'Compare', title: 'Patterns', tone: 'warm' },
  { label: 'Follow', title: 'Questions', tone: 'soft' },
];
